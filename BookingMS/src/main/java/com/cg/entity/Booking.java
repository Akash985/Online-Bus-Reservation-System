...
public class Booking {
	...
	public Date getDatOfBooking() {
		return datOfBooking;
	}
	public void setDatOfBooking(Date datOfBooking) {
		this.datOfBooking = datOfBooking;
	}
	@Override
